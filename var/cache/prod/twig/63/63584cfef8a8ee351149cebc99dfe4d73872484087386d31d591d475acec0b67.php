...
/* components/frontShopMalo.html.twig */
class __TwigTemplate_f29c7d0bfba88f29fae5dc7a6f912d26af7b2eed56bd8b417cb4e84479faafae extends Template
{
    private $source;
    private $macros = [];
    ...
    <section class=\"text-gray-800 text-center \">
        ...
        <div class=\"px-6 md:px-12\">
            <div class=\"container mx-auto\">
                <div class=\"grid lg:grid-cols-2 items-center py-12\">
                    <div style=\"z-index: 1\" class=\"md:mt-12 lg:mt-0 pb-12\">
                        <div class=\"pb-12 text-white border-end\">
                            <p class=\"font-bold text-3xl \">Les saveurs Fromagères<br>à Malo</p>
                        </div>
                        <div class=\"block h-96 bg-stone-700 rounded-lg shadow-lg px-6 py-12 md:px-12 lg:-mr-14\">
                            ...
                            <div class=\"flex flex-wrap \">
                                <div class=\"mb-12 lg:mb-0 text-center mx-auto\">
                                    ...
                                    <h6 class=\"font-medium text-white\">55 Av. Faidherbe,<br>59240 Dunkerque</h6>
                                </div>
                                ...
                                <div class=\"mb-12 md:mb-0 text-center mx-auto\">
                                    ...
                                    <a class=\"text-white\" href=\"tel:03 28 25 14 26\"> 03 28 25 14 26</a>
                                </div>
                            </div>
            ...
            <span class=\"text-sm py-2 px-4 font-normal block w-full whitespace-nowrap bg-stone-600 text-white\">
                    ...
                    <div class=\" \">
                        <div style=\"height: 700px\" class=\" relative  shadow-lg rounded-lg\">
                            <iframe src=\"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7094.745223497677!2d2.382435202783527!3d51.046232845306335!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47dc8d2010842081%3A0xd015fce93aa2e13a!2sLes%20saveurs%20fromag%C3%A8res%20Malo!5e0!3m2!1sfr!2sfr!4v1671752825948!5m2!1sfr!2sfr\" class=\"left-0 top-0 h-full w-full absolute rounded-lg\" frameborder=\"0\" allowfullscreen></iframe>
                        </div>
                    </div>
                </div>
            </div>
    ...
    {
        return "components/frontShopMalo.html.twig";
    }
    ...
    {
        return new Source("", "components/frontShopMalo.html.twig", "/home/ddevfry/www/LSF/templates/components/frontShopMalo.html.twig");
    }
}
