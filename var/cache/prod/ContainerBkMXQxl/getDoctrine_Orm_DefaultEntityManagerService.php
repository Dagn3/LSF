...
class getDoctrine_Orm_DefaultEntityManagerService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Repository\\FromageRepository' => ['privates', 'App\\Repository\\FromageRepository', 'getFromageRepositoryService', true],
            'App\\Repository\\LabelRepository' => ['privates', 'App\\Repository\\LabelRepository', 'getLabelRepositoryService', true],
            'App\\Repository\\LaitRepository' => ['privates', 'App\\Repository\\LaitRepository', 'getLaitRepositoryService', true],
            'App\\Repository\\MessageRepository' => ['privates', 'App\\Repository\\MessageRepository', 'getMessageRepositoryService', true],
            'App\\Repository\\PateRepository' => ['privates', 'App\\Repository\\PateRepository', 'getPateRepositoryService', true],
            'App\\Repository\\ProvenanceRepository' => ['privates', 'App\\Repository\\ProvenanceRepository', 'getProvenanceRepositoryService', true],
