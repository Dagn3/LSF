...
class App_KernelProdContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Admin\\FromageCrudController' => 'getFromageCrudControllerService',
            'App\\Controller\\Admin\\LabelCrudController' => 'getLabelCrudControllerService',
            'App\\Controller\\Admin\\LaitCrudController' => 'getLaitCrudControllerService',
            'App\\Controller\\Admin\\MessageCrudController' => 'getMessageCrudControllerService',
            'App\\Controller\\Admin\\PateCrudController' => 'getPateCrudControllerService',
            'App\\Controller\\Admin\\ProvenanceCrudController' => 'getProvenanceCrudControllerService',
            ...
            'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.fromage_images' => 'getSmartUniqueNamer_FromageImagesService',
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('EasyCorp\\Bundle\\EasyAdminBundle\\Event\\BeforeEntityPersistedEvent', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\Easyadmin'] ?? $this->load('getEasyadminService'));
        }, 1 => 'addUser'], 0);
        $instance->addListener('EasyCorp\\Bundle\\EasyAdminBundle\\Event\\BeforeEntityDeletedEvent', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\Easyadmin'] ?? $this->load('getEasyadminService'));
        }, 1 => 'DelUser'], 0);
        ...
        $instance->addListener('EasyCorp\\Bundle\\EasyAdminBundle\\Event\\AfterEntityPersistedEvent', [0 => function () {
            return ($this->privates['App\\Listener\\EasyAdminListener'] ?? ($this->privates['App\\Listener\\EasyAdminListener'] = new \App\Listener\EasyAdminListener()));
        }, 1 => 'flashMessageAfterPersist'], 0);
        $instance->addListener('EasyCorp\\Bundle\\EasyAdminBundle\\Event\\AfterEntityUpdatedEvent', [0 => function () {
            return ($this->privates['App\\Listener\\EasyAdminListener'] ?? ($this->privates['App\\Listener\\EasyAdminListener'] = new \App\Listener\EasyAdminListener()));
        }, 1 => 'flashMessageAfterUpdate'], 0);
        $instance->addListener('EasyCorp\\Bundle\\EasyAdminBundle\\Event\\AfterEntityDeletedEvent', [0 => function () {
            return ($this->privates['App\\Listener\\EasyAdminListener'] ?? ($this->privates['App\\Listener\\EasyAdminListener'] = new \App\Listener\EasyAdminListener()));
        }, 1 => 'flashMessageAfterDelete'], 0);
        $instance->addListener('kernel.response', [0 => function () {
    ...
    {
        return $this->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Registry\\CrudControllerRegistry'] = new \EasyCorp\Bundle\EasyAdminBundle\Registry\CrudControllerRegistry($this->getEnv('APP_SECRET'), [0 => 'App\\Controller\\Admin\\FromageCrudController', 1 => 'App\\Controller\\Admin\\LabelCrudController', 2 => 'App\\Controller\\Admin\\LaitCrudController', 3 => 'App\\Controller\\Admin\\MessageCrudController', 4 => 'App\\Controller\\Admin\\PateCrudController', 5 => 'App\\Controller\\Admin\\ProvenanceCrudController', 6 => 'App\\Controller\\Admin\\UserCrudController']);
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ZIHg+ICrdQ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['knp_paginator.subscriber.sliding_pagination'] = new \Knp\Bundle\PaginatorBundle\Subscriber\SlidingPaginationSubscriber(['defaultPaginationTemplate' => 'components/pagination.html.twig', 'defaultSortableTemplate' => '@KnpPaginator/Pagination/sortable_link.html.twig', 'defaultFiltrationTemplate' => '@KnpPaginator/Pagination/filtration.html.twig', 'defaultPageRange' => 5, 'defaultPageLimit' => NULL]);
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'fromage_images' => '/uploads/fromages',
            ...
            'twig.form.resources' => [
                ...
                2 => 'components/tailwind_2_layout.html.twig',
            ],
            ...
            'vich_uploader.mappings' => [
                'fromage_images' => [
                    'uri_prefix' => '/uploads/fromages',
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/uploads/fromages'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.fromage_images',
                        'options' => [
            ...
            'knp_paginator.template.pagination' => 'components/pagination.html.twig',
