...
class getDoctrine_Dbal_DefaultConnectionService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory($container->parameters['doctrine.dbal.connection_factory.types']))->createConnection(['url' => $container->getEnv('resolve:DATABASE_URL'), 'driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => [], 'defaultTableOptions' => []], $a, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            ...
            'vich_uploader.listener.clean.fromage_images' => ['privates', 'vich_uploader.listener.clean.fromage_images', 'getVichUploader_Listener_Clean_FromageImagesService', true],
            'vich_uploader.listener.remove.fromage_images' => ['privates', 'vich_uploader.listener.remove.fromage_images', 'getVichUploader_Listener_Remove_FromageImagesService', true],
            'vich_uploader.listener.upload.fromage_images' => ['privates', 'vich_uploader.listener.upload.fromage_images', 'getVichUploader_Listener_Upload_FromageImagesService', true],
        ], [
            ...
            'vich_uploader.listener.clean.fromage_images' => '?',
            'vich_uploader.listener.remove.fromage_images' => '?',
            'vich_uploader.listener.upload.fromage_images' => '?',
        ]), [0 => 'vich_uploader.listener.clean.fromage_images', 1 => 'doctrine.orm.messenger.doctrine_schema_subscriber', 2 => 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_subscriber', 3 => 'doctrine.orm.listeners.pdo_cache_adapter_doctrine_schema_subscriber', 4 => 'doctrine.orm.listeners.doctrine_token_provider_schema_subscriber', 5 => 'vich_uploader.listener.remove.fromage_images', 6 => 'vich_uploader.listener.upload.fromage_images', 7 => [0 => [0 => 'loadClassMetadata'], 1 => 'doctrine.orm.default_listeners.attach_entity_listeners']]), []);
    }
}
