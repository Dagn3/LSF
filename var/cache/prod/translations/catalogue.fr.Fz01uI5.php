...
$catalogue = new MessageCatalogue('fr', array (
  ...
  'admin' => 
  array (
    'content_admin.flash_message.create' => 'Le contenu "%name%" a été créé avec succès.',
    'content_admin.flash_message.update' => 'Le contenu "%name%" a été mis à jour avec succès.',
    'content_admin.flash_message.delete' => 'Le contenu "%name%" a été supprimé avec succès.',
  ),
));
